...
*/
void OS_MallocLock  (void) OS_TEXT_SECTION_ATTRIBUTE(OS_MallocLock);
void OS_MallocUnlock(void) OS_TEXT_SECTION_ATTRIBUTE(OS_MallocUnlock);
...
void OS_TASK_SetContextExtensionTLS(struct _reent * pReentStruct) OS_TEXT_SECTION_ATTRIBUTE(OS_TASK_SetContextExtensionTLS);  // Initialize Thread Local Storage, OS_TLS.c, CPU specific
//
