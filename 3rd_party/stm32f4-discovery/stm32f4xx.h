 ...
 * - added macro #define HSE_VALUE 8000000 for the STM32F4-Discovery board
 * - added macro #define STM32F40XX 1      for the STM32F4-Discovery board
 * - added macro #define __FPU_PRESENT 1   for the STM32F4-Discovery board
 *
...
/**
* @attention
* The following macros are specific to the STM32F4-Discovery board.
* The macro "HSE_VALUE" overrides the define in "stm32f4xx.h" file, where it
* is set to 25MHz. You need to adjust this value if you use other olsillator
* in your project.
*/
