...
* Date of the Last Update:  Jul 06, 2008
*
...
__arm void BSP_irq(void) {
    ...
    QF_INT_UNLOCK_32();                         /* allow nesting interrupts */
    (*vect)();              /* call the IRQ ISR via the pointer to function */
    QF_INT_LOCK_32();            /* disable interrups for the exit sequence */
...
__arm void TIM3_IRQHandler(void) {
    ...
    QF_tick();                      /* process all arm time events (timers) */
}
/*..........................................................................*/
...
__arm void QF_onStartup(void) {
    ...
    QF_INT_LOCK_32();         /* make sure that all interrupts are disabled */
    ...
    QF_INT_UNLOCK_32();                               /* unlock intgerrupts */
}
/*..........................................................................*/
void QF_onCleanup(void) {
}
/*..........................................................................*/
void QF_onIdle(QF_INT_KEY_TYPE key) {            /* NOTE: interrupts LOCKED */
...
// get control of the MCU again!!!
    ...
    QF_INT_UNLOCK(key);    /* unlock interrupts as soon as CPU clock starts */
