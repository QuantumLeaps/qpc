...
(version 1.3.0) running on top of the QP™ state machine framework, which are
...
C Luminary Micro changed the graphical OLED display from OSRAM 128x64x4 to
RITEK 128x96x4. If you happen to have the earlier board (Revision A or B), you
can still use the examples by commenting out the macro RITEK_OLED and defining
the macro OSRAM_OLED in bsp.h
