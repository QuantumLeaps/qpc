/*****************************************************************************
* Product: BSP for MCF52223-SK board, with the QK preemptive kernel
* Last Updated for Version: 4.0.00
* Date of the Last Update:  Apr 28, 2008
*
...
#endif
    QK_ISR_ENTRY(PIT0_LEVEL);           /* inform QK about entering the ISR */
