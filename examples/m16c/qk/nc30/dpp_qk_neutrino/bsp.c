/*****************************************************************************
* Product: DPP example, M16C/Neutrino board, QK kernel
...
//    LED0_DDR = 1;      /* pins used by LED0 and LED1 are needed for UART2 */
//    LED1_DDR = 1;
    LED2_DDR = 1;
    LED3_DDR = 1;
//    LED0     = LED_OFF;
...
void BSP_displyPhilStat(uint8_t n, char const *stat) {
    ...
    switch (n) {
                         /* pins used by LED0 and LED1 are needed for UART2 */
