/*****************************************************************************
* Product: DPP example, SKP28 board, NC30 compiler, QK kernel
...
#ifdef Q_SPY
    if (ir_ta1ic != 0) {                  /* TimerA1 interrupt request set? */
        ++l_nTimerA1Underflows; /* account for 16-bit underflow (0->0xFFFF) */
        ir_ta1ic = 0;                           /* clear the interrupt flag */
    }
#endif
...
void BSP_init(void) {
    ...
    LED1 = LED_OFF;
    LED2 = LED_OFF;
                                /* configure 32kHz sub clock..., see NOTE01 */
...
void QK_onIdle(void) {
    ...
    _asm("WAIT");             /* entering any pending interrupt */
#endif
}
/*..........................................................................*/
...
uint8_t QS_onStartup(void const *arg) {
    ...
    */
    u0brg = (uint8_t)(((f1_CLK_HZ/16 + QS_BAUD_RATE/2)
                      / QS_BAUD_RATE) - 1);
