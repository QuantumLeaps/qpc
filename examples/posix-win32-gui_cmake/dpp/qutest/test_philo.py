...
expect("@timestamp AO-Post  Sdr=QS_RX,Obj=Philo_inst[2],Evt<Sig=TIMEOUT_SIG,*")
expect("@timestamp AO-GetL  Obj=Philo_inst[2],Evt<Sig=TIMEOUT_SIG,*")
...
expect("@timestamp AO-Post  Sdr=Philo_inst[2],Obj=Table_dummy,Evt<Sig=HUNGRY_SIG,Pool=1,Ref=1>*")
...
expect("@timestamp QF-Pub   Sdr=Philo_inst[2],Evt<Sig=DONE_SIG,Pool=1,Ref=0>")
...
expect("@timestamp MP-Get   Obj=EvtPool1,*")
expect("@timestamp QF-New   Sig=HUNGRY_SIG,*")
expect("@timestamp AO-Post  Sdr=Philo_inst[2],Obj=Table_dummy,Evt<Sig=HUNGRY_SIG,Pool=1,*")
expect("@timestamp QUTEST_ON_POST HUNGRY_SIG,Obj=Table_dummy 2")
expect("@timestamp QF-gc    Evt<Sig=HUNGRY_SIG,*")
