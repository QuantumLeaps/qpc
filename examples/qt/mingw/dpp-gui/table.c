...
/* @(/1/0) .................................................................*/
/* @(/1/0/1) ...............................................................*/
TableEvt * TableEvt_ctor(TableEvt * const me, QSignal sig, uint8_t philoNum) {
    QEvt_ctor(&me->super, sig);
    me->philoNum = philoNum;
    return me;
}
/*..........................................................................*/
/* @(/2/5) .................................................................*/
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            ...
            for (n = 0U; n < N_PHILO; ++n) { /* give permissions to eat... */
                    ...
                    && (me->fork[n] == FREE))
                {
                    me->fork[LEFT(n)] = USED;
                    me->fork[n] = USED;
                    QF_PUBLISH((QEvt *)Q_NEW(TableEvt, EAT_SIG, n), me);
                    me->isHungry[n] = 0U;
        ...
        case DONE_SIG: {
            ...
            if ((me->isHungry[m] != 0U) && (me->fork[m] == FREE)) {
                ...
                me->fork[m] = USED;
                me->isHungry[m] = 0U;
                QF_PUBLISH((QEvt *)Q_NEW(TableEvt, EAT_SIG, m), me);
