...
def on_reset():
    ...
    expect("@timestamp TE0-Arm  Obj=Philo_inst[0].timeEvt,AO=Table_inst,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP_random *")
    expect("@timestamp TE0-Arm  Obj=Philo_inst[1].timeEvt,AO=Table_inst,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP_random *")
    expect("@timestamp TE0-Arm  Obj=Philo_inst[3].timeEvt,AO=Table_inst,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP_random *")
    expect("@timestamp TE0-Arm  Obj=Philo_inst[4].timeEvt,AO=Table_inst,Tim=*,Int=0")
