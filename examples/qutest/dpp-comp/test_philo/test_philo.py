...
expect("@timestamp TE0-Dis  Obj=Philo_inst[2].timeEvt,AO=Table_inst,Tim=*,Int=0")
expect("===RTC===> St-Exit  Obj=Philo_inst[2],State=Philo_thinking")
expect("@timestamp MP-Get   Obj=EvtPool1,*")
expect("@timestamp QF-New   Sig=HUNGRY_SIG,*")
expect("@timestamp AO-LIFO  Obj=Table_inst,Evt<Sig=HUNGRY_SIG,*")
...
expect("@timestamp AO-LIFO  Obj=Table_inst,Evt<Sig=DONE_SIG,*")
