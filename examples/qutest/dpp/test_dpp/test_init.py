...
def on_reset(qutest):
    ...
    qutest.expect("===RTC===> St-Init  Obj=AO_Philo<0>,State=QHsm_top->Philo_thinking")
    qutest.expect("%timestamp BSP_CALL BSP_random *")
    qutest.expect("%timestamp TE0-Arm  Obj=l_philo<0>.timeEvt,AO=AO_Philo<0>,Tim=*,Int=0")
    qutest.expect("===RTC===> St-Entry Obj=AO_Philo<0>,State=Philo_thinking")
    qutest.expect("%timestamp Init===> Obj=AO_Philo<0>,State=Philo_thinking")
    qutest.expect("%timestamp AO-Subsc Obj=AO_Philo<1>,Sig=EAT_SIG")
    qutest.expect("%timestamp AO-Subsc Obj=AO_Philo<1>,Sig=TEST_SIG")
    qutest.expect("===RTC===> St-Init  Obj=AO_Philo<1>,State=QHsm_top->Philo_thinking")
    qutest.expect("%timestamp BSP_CALL BSP_random *")
    qutest.expect("%timestamp TE0-Arm  Obj=l_philo<1>.timeEvt,AO=AO_Philo<1>,Tim=*,Int=0")
    qutest.expect("===RTC===> St-Entry Obj=AO_Philo<1>,State=Philo_thinking")
    qutest.expect("%timestamp Init===> Obj=AO_Philo<1>,State=Philo_thinking")
    ...
    qutest.expect("===RTC===> St-Init  Obj=AO_Philo<3>,State=QHsm_top->Philo_thinking")
    qutest.expect("%timestamp BSP_CALL BSP_random *")
    qutest.expect("%timestamp TE0-Arm  Obj=l_philo<3>.timeEvt,AO=AO_Philo<3>,Tim=*,Int=0")
    qutest.expect("===RTC===> St-Entry Obj=AO_Philo<3>,State=Philo_thinking")
    qutest.expect("%timestamp Init===> Obj=AO_Philo<3>,State=Philo_thinking")
    qutest.expect("%timestamp AO-Subsc Obj=AO_Philo<4>,Sig=EAT_SIG")
    qutest.expect("%timestamp AO-Subsc Obj=AO_Philo<4>,Sig=TEST_SIG")
    qutest.expect("===RTC===> St-Init  Obj=AO_Philo<4>,State=QHsm_top->Philo_thinking")
    qutest.expect("%timestamp BSP_CALL BSP_random *")
    qutest.expect("%timestamp TE0-Arm  Obj=l_philo<4>.timeEvt,AO=AO_Philo<4>,Tim=*,Int=0")
    qutest.expect("===RTC===> St-Entry Obj=AO_Philo<4>,State=Philo_thinking")
    qutest.expect("%timestamp Init===> Obj=AO_Philo<4>,State=Philo_thinking")
