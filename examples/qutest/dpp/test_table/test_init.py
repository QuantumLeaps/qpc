...
def on_reset():
    ...
    continue_test()
    expect("===RTC===> St-Init  Obj=Philo_inst[0],State=QHsm_top->NULL")
    expect("@timestamp AO-Subsc Obj=Philo_inst[0],Sig=EAT_SIG")
    expect("===RTC===> St-Init  Obj=Philo_inst[1],State=QHsm_top->NULL")
    expect("@timestamp AO-Subsc Obj=Philo_inst[1],Sig=EAT_SIG")
    expect("===RTC===> St-Init  Obj=Philo_inst[2],State=QHsm_top->NULL")
    expect("@timestamp AO-Subsc Obj=Philo_inst[2],Sig=EAT_SIG")
    expect("===RTC===> St-Init  Obj=Philo_inst[3],State=QHsm_top->NULL")
    expect("@timestamp AO-Subsc Obj=Philo_inst[3],Sig=EAT_SIG")
    expect("===RTC===> St-Init  Obj=Philo_inst[4],State=QHsm_top->NULL")
