...
int main(void) {
    ...
    LwIPMgr_ctor();           /* instantiate the LwIP-Manager active object */
    ...
    QActive_start(AO_LwIPMgr, 1U,
                  l_lwIPMgrQueueSto, Q_DIM(l_lwIPMgrQueueSto),
                  (void *)0, 0U, (QEvt *)0);

    for (n = 0U; n < N_PHILO; ++n) {
        QActive_start(AO_Philo[n], (uint8_t)(n + 2U),
                      l_philoQueueSto[n], Q_DIM(l_philoQueueSto[n]),
                      (void *)0, 0U, (QEvt *)0);
    }
    QActive_start(AO_Table, (uint8_t)(N_PHILO + 2U),
