...
#include "iodefine.h"
#include "yrdkrx63n.h"
#include "lcd.h"                                    /* for the graphics LCD */
...
void BSP_init(void) {
    ...
    */
    ...
    lcd_initialize();
    lcd_clear();
    lcd_display(LCD_LINE1, "  Quantum Leaps ");
    lcd_display(LCD_LINE2, "  state-machine.com");
...
//    QS_FILTER_OFF(QS_QF_TICK);
    ...
    QS_FILTER_OFF(QS_QK_ISR_ENTRY);
    QS_FILTER_OFF(QS_QK_ISR_EXIT);
