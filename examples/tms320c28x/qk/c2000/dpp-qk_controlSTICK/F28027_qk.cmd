/* Modified by Quantum Leaps for the QP/QK port
// Last update $Date: February 13, 2012 $
*/
...
//
// For BIOS applications add:      DSP+2802x_Headers_BIOS.cmd
...
SECTIONS
{
                         ...
                         PAGE = 0
   {
      ...
      qp2800_ml.lib<qk_sched.obj>(.text)
      qp2800_ml.lib<qk.obj>      (.text)
   }
