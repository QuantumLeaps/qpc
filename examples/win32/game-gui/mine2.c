...
static QState Mine2_planted(Mine2 * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case TIME_TICK_SIG: {
            /* ${AOs::Mine2::SM::used::planted::TIME_TICK::[me->x>=GAME_SPE~} */
        ...
        case SHIP_IMG_SIG: {
            ...
            /* ${AOs::Mine2::SM::used::planted::SHIP_IMG::[collisionwithMI~} */
        ...
        case MISSILE_IMG_SIG: {
            ...
            uint8_t y   = Q_EVT_CAST(ObjectImageEvt)->y;
            uint8_t bmp = Q_EVT_CAST(ObjectImageEvt)->bmp;
            /* ${AOs::Mine2::SM::used::planted::MISSILE_IMG::[collisionwithMI~} */
