...
static QState Calc_operand_int  (Calc * const me, QEvt const * const e);
static QState Calc_operand_int_e(Calc * const me);
static QState Calc_operand_int_x(Calc * const me);
static QMState const Calc_operand_int_s = {
    &Calc_operand_s, /* superstate */
