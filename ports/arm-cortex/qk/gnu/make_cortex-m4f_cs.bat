...
if "%1"=="" (
    ...
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -O
    set ASMFLAGS=-g -mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=%QP_PRTDIR%\rel
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -Os -DNDEBUG
    set ASMFLAGS=-mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=%QP_PRTDIR%\spy
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -O -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_cs.a %BINDIR%\qep.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_cs.a %BINDIR%\qs.o %BINDIR%\qs_.o %BINDIR%\qs_blk.o %BINDIR%\qs_byte.o %BINDIR%\qs_f32.o %BINDIR%\qs_f64.o %BINDIR%\qs_mem.o %BINDIR%\qs_str.o
@echo off
erase %BINDIR%\*.o
