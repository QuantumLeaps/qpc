@echo off
:: ===========================================================================
:: Product: QP/C buld script for ARM Cortex-M0, Vanilla, GNU/CodeRed compiler
...
if "%1"=="" (
    ...
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -O -DARM_ARCH_V6M -D__REDLIB__
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=%QP_PRTDIR%\rel
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mthumb -Wall -Os -DARM_ARCH_V6M -D__REDLIB__ -DNDEBUG
    set ASMFLAGS=-mcpu=%ARM_CORE%
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=%QP_PRTDIR%\spy
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -O -DARM_ARCH_V6M -D__REDLIB__ -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%_cr.a %BINDIR%\qep.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%_cr.a %BINDIR%\qs.o %BINDIR%\qs_.o %BINDIR%\qs_blk.o %BINDIR%\qs_byte.o %BINDIR%\qs_f32.o %BINDIR%\qs_f64.o %BINDIR%\qs_mem.o %BINDIR%\qs_str.o
@echo off
erase %BINDIR%\*.o
