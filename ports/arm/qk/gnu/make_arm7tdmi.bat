...
@echo on
%CC% -marm   %CCFLAGS% %CCINC% %SRCDIR%\qk.c       -o%BINDIR%\qk.o
%CC% -marm   %CCFLAGS% %CCINC% %SRCDIR%\qk_sched.c -o%BINDIR%\qk_sched.o
%CC% -marm   %CCFLAGS% %CCINC% %SRCDIR%\qk_mutex.c -o%BINDIR%\qk_mutex.o
%ASM% src\qk_port.s -o %BINDIR%\qk_port.o %ASMFLAGS%
