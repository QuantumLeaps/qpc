...
@echo on
%CC% --cpu_mode arm --section .text=.textrw %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qk.c
%CC% --cpu_mode arm --section .text=.textrw %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qk_sched.c
%CC% --cpu_mode arm --section .text=.textrw %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qk_mutex.c
%ASM% src\qk_port.s -o %BINDIR%\qk_port.o %ASMFLAGS%

erase %LIBDIR%\qk_%ARM_CORE%.a
%LIB% %LIBFLAGS% -o%LIBDIR%\qk_%ARM_CORE%.a %BINDIR%\qk.o %BINDIR%\qk_sched.o %BINDIR%\qk_mutex.o %BINDIR%\qk_port.o
@echo off
