@echo off
:: ==========================================================================
:: Product: QP/C buld script for AVR-xmega, QK port, GNU compiler
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk_port.o  qk_port.s

%LIB% %LIBFLAGS% %LIBDIR%\libqk_%TARGET_MCU%.a %BINDIR%\qk.o %BINDIR%\qk_sched.o %BINDIR%\qk_mutex.o
@echo OFF
