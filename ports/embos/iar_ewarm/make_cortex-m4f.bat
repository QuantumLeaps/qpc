...
:: define the EMBOS environment variable to point to the location 
:: where you've installed the embOS RTOS
if "%EMBOS%"=="" set EMBOS="D:\software\embOS\Start"
...
set CCINC=-I%QP_PRTDIR% -I%QP_INCDIR% -I%EMBOS_INCDIR% -I%SRCDIR%
...
%CC% %CCFLAGS% %CCOPT% %CCINC% -o%BINDIR%\ %QP_PRTDIR%\qf_port.c

%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%.a %BINDIR%\qa_ctor.o %BINDIR%\qa_defer.o %BINDIR%\qa_sub.o %BINDIR%\qa_usub.o %BINDIR%\qa_usuba.o %BINDIR%\qeq_fifo.o %BINDIR%\qeq_get.o %BINDIR%\qeq_init.o %BINDIR%\qeq_lifo.o %BINDIR%\qf_act.o %BINDIR%\qf_gc.o %BINDIR%\qf_log2.o %BINDIR%\qf_new.o %BINDIR%\qf_pool.o %BINDIR%\qf_psini.o %BINDIR%\qf_pspub.o %BINDIR%\qf_pwr2.o %BINDIR%\qf_tick.o %BINDIR%\qma_ctor.o %BINDIR%\qmp_get.o %BINDIR%\qmp_init.o %BINDIR%\qmp_put.o %BINDIR%\qte_ctor.o %BINDIR%\qte_arm.o %BINDIR%\qte_darm.o %BINDIR%\qte_rarm.o %BINDIR%\qte_ctr.o  %BINDIR%\qf_port.o
@echo off
erase %BINDIR%\*.o
