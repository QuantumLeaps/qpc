@echo off
rem ==========================================================================
rem Product: QP/C library buld script, H8, QK port, Renesas H8 compiler
rem Last Updated for Version: 4.0.01
rem Date of the Last Update:  Sep 01, 2008
rem
