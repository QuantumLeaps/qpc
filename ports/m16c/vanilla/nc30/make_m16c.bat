@echo off
rem ==========================================================================
rem Product: QP/C library buld script for M16C Vanilla port with NC30
rem Last Updated for Version: 4.0.01
rem Date of the Last Update:  Aug 20, 2008
rem
...
if "%1"=="" (
    ...
    set CCFLAGS=-c -g -v -Wall
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=%QP_PRTDIR%\rel
    set CCFLAGS=-c -O3 -v -Wall -DNDEBUG
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=%QP_PRTDIR%\spy
    set CCFLAGS=-c -g -v -Wall -DQ_SPY
)
