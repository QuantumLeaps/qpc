/*****************************************************************************
* Product:  QF/C, Renesas RX, QK port, Renesas compiler
...
#define QF_CRIT_ENTRY(dummy)        clr_psw_i()
#define QF_CRIT_EXIT(dummy)         set_psw_i()

                                                      /* inline definitions */
#pragma inline_asm clr_psw_i
static void clr_psw_i(void) { CLRPSW I }

#pragma inline_asm set_psw_i
static void set_psw_i(void) { SETPSW I }
