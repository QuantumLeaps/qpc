/*****************************************************************************
* Product:  QS/C, port to TMS320C2802x, TI C2000 compiler
...
#define QS_INSERT_BYTE(b_) \
    __byte((int *)QS_ring_, QS_head_) = (b_); \
    if (++QS_head_ == QS_end_) { \
        QS_head_ = (QSCtr)0; \
    } \
    ++QS_used_;
...
char_t const Q_ROM * Q_ROM_VAR QS_getVersion(void) {
    static char_t const Q_ROM Q_ROM_VAR version[] = "4.5.03";
    return version;
}
/*..........................................................................*/
...
uint16_t QS_getByte(void) {
    ...
    byte = __mov_byte((int *)QS_ring_, QS_tail_); /* set the byte to return */
